...
public class SimpleMinimaxPlayer extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SimpleMinimaxPlayer frame = new SimpleMinimaxPlayer();
		...
		btnHelp.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "U Nim igri dva igraca "
						...
						+ "Poslednji igrac koji ukloni zeton dobija igru.");
			}
		});
	...
	private void addPiles(int nPiles) {
		lblPiles = new JLabel[nPiles][nPiles];      // !!$$$$$mislim da je zbog ovoga greska sa onim preko 7 
		int verSpace = 20, horSpace = 50;           // jer generisemo 
