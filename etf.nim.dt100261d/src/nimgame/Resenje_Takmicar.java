...
public class Resenje_Takmicar extends JFrame {
	...
	public static int playerTakmicar = 0;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Resenje_Takmicar frame = new Resenje_Takmicar();
				...
				lblPiles[i][j].addMouseListener(new MouseAdapter() {
					...
					public void mouseClicked(MouseEvent e) {
						...
						if (game.currentPlayer == The100Game.PLAYER1) {
							...
							playerTakmicar = 0;  // ovo cu kasnije dodati kad realizujem  alfaBeta
